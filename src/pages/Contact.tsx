...
const Contact: React.FC = () => (
  <div className="flex flex-1 justify-center items-center bg-[#f5efe6] py-10 px-2 pt-24" style={{ paddingTop: '10rem' }}>
    <div className="w-full max-w-lg bg-[#ddc8aa] rounded-2xl shadow-xl p-8 md:p-12 border border-[#e5d6be] flex flex-col items-center text-center" style={{padding: '20px'}}>
